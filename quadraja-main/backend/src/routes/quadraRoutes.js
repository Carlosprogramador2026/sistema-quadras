...
import { auth, requireGestor, optionalAuth } from '../middlewares/auth.js';
...
// optionalAuth: so libera ?todas=true (inclui inativas) se for o gestor.
router.get('/', optionalAuth, quadraController.listar);
